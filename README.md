<img src="https://raw.githubusercontent.com/LucaCamerani/EcoFin-Library/master/EcoFin/LOGO.png" width="200">
...
* Implied Volatility Spread (IVS) analisys
* Option Price Spread (OPS) analisys


The streght of this project is to enclose in a single library all the quantitative finance functions from data download to data analisys, in order to realize complete investment strategies.<br>
